...
const DateInput: React.FC<{
  ...
  <div className="flex flex-col">
    ...
    <input
      ...
      className="mt-1 p-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 w-full"
    />
  </div>
);
...
const DynamicFormItem: React.FC<{
  ...
  return (
    <div className="p-4 border border-gray-200 rounded-xl mb-4 bg-white transition duration-150 shadow-sm hover:shadow-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-lg mb-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* 이미지 영역 */}
              <div className="flex flex-col items-center justify-center col-span-1 p-4 border-2 border-dashed border-gray-300 rounded-xl hover:border-blue-400 transition cursor-pointer relative group">
                <input
                  type="file"
                  accept="image/*"
                ...
                {profile.profileImage ? (
                  ...
                  <div className="flex flex-col items-center text-gray-500 p-4">
                    <Camera
                      size={40}
                      className="mb-2 group-hover:text-blue-500"
                    />
          ...
          <div className="flex justify-end pt-4">
            <button
              type="submit"
              className="px-8 py-3 bg-black text-white font-semibold rounded-xl shadow-md hover:bg-gray-800 transition duration-150"
            >
              저장하기
            </button>
          </div>
